...
* [Creating A Text Generator Using Recurrent Neural Network](https://mahaveer0suthar.github.io/project/Creating-Text-Generator-Using-Recurrent-Neural-Network/){:target="_blank"}
...
(You can find the whole source files on my GitHub repository here: [seq2seq](https://github.com/mahaveer0suthar/seq2seq){:target="_blank"})
